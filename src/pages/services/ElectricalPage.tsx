...
import { ArrowRight, Phone, CheckCircle, Zap, Lightbulb, Shield, Clock, Award, Plug, Power, CircuitBoard } from 'lucide-react';
...
const ElectricalPage = () => {
    ...
    const services = [
        { title: t.electrical.panelUpgrades, description: t.electrical.panelUpgradesDesc, icon: Power },
        { title: t.electrical.rewiring, description: t.electrical.rewiringDesc, icon: CircuitBoard },
        { title: t.electrical.lightingInstallation, description: t.electrical.lightingInstallationDesc, icon: Lightbulb },
        { title: t.electrical.outletInstallation, description: t.electrical.outletInstallationDesc, icon: Plug },
        { title: t.electrical.ceilingFans, description: t.electrical.ceilingFansDesc, icon: Zap },
        { title: t.electrical.emergencyRepairs, description: t.electrical.emergencyRepairsDesc, icon: Clock },
    ];
    ...
    const stats = [
        { value: '200+', label: t.electrical.servicesTitle },
    ...
    const whyChoose = [
        { title: t.electrical.licensedCertified, desc: t.electrical.licensedCertifiedDesc },
        { title: t.electrical.safetyFirst, desc: t.electrical.safetyFirstDesc },
        { title: t.electrical.upfrontPricing, desc: t.electrical.upfrontPricingDesc },
        { title: t.electrical.bilingualService, desc: t.electrical.bilingualServiceDesc },
    ];
        ...
        <div className="min-h-screen bg-charcoal">
            ...
            <section className="relative min-h-[80vh] flex items-center justify-center pt-16">
                <div className="absolute inset-0 z-0">
                    ...
                    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1621905251189-08b45d6a269e?w=1920')] bg-cover bg-center opacity-30" />
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-flex items-center gap-2 bg-copper/20 border border-copper/30 rounded-full px-4 py-2 mb-6">
                        ...
                        <span className="text-copper text-sm font-medium">{t.servicePage.licensedElectricians}</span>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                            {t.electrical.servicesTitle.split(' ')[0]} <span className="text-copper">{t.electrical.servicesTitle.split(' ').slice(1).join(' ')}</span>
                        </h2>
                        <p className="text-steel text-lg max-w-2xl mx-auto">
                            {t.electrical.servicesSubtitle}
                        </p>
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative">
                            <img
                                src="https://images.unsplash.com/photo-1621905252507-b35b647bca82?w=600"
            ...
            <section className="py-20 bg-gradient-to-b from-charcoal to-charcoal/80">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-8">
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                            {t.electrical.formTitle}
                        </h2>
                        <p className="text-steel text-lg">
                            {t.electrical.formSubtitle}
                        </p>
                    </div>
                    <LeadForm />
                </div>
            ...
            <section className="py-16 bg-copper">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-charcoal mb-4">
                        {t.electrical.ctaTitle}
                    </h2>
                    <p className="text-charcoal/80 mb-8">
                        {t.electrical.ctaSubtitle}
                    </p>

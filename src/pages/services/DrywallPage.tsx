...
import { ArrowRight, Phone, CheckCircle, LayoutGrid, Clock, Award, Ruler, PaintBucket, Hammer, Sparkles } from 'lucide-react';
...
const DrywallPage = () => {
    ...
    const services = [
        { title: t.drywall.drywallInstallation, description: t.drywall.drywallInstallationDesc, icon: LayoutGrid },
        { title: t.drywall.drywallRepair, description: t.drywall.drywallRepairDesc, icon: Hammer },
        { title: t.drywall.textureApplication, description: t.drywall.textureApplicationDesc, icon: Sparkles },
        { title: t.drywall.popcornRemoval, description: t.drywall.popcornRemovalDesc, icon: PaintBucket },
        { title: t.drywall.finishingTaping, description: t.drywall.finishingTapingDesc, icon: Ruler },
        { title: t.drywall.soundproofing, description: t.drywall.soundproofingDesc, icon: LayoutGrid },
    ];
    ...
    const stats = [
        { value: '300+', label: t.drywall.servicesTitle },
    ...
    const whyChoose = [
        { title: t.drywall.flawlessFinishing, desc: t.drywall.flawlessFinishingDesc },
        { title: t.drywall.fastTurnaround, desc: t.drywall.fastTurnaroundDesc },
        { title: t.drywall.allTextures, desc: t.drywall.allTexturesDesc },
        { title: t.drywall.cleanWorksite, desc: t.drywall.cleanWorksiteDesc },
    ];
            ...
            <section className="relative min-h-[80vh] flex items-center justify-center pt-16">
                ...
                <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-flex items-center gap-2 bg-copper/20 border border-copper/30 rounded-full px-4 py-2 mb-6">
                        <LayoutGrid className="w-4 h-4 text-copper" />
                        <span className="text-copper text-sm font-medium">{t.servicePage.professionalDrywall}</span>
                    </div>

                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                        {t.drywall.title}
                        <span className="block text-copper">{t.drywall.titleAccent}</span>
                    </h1>

                    <p className="text-xl text-offwhite/80 mb-8 max-w-3xl mx-auto">
                        {t.drywall.heroSubtitle}
                    </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                            {t.drywall.servicesTitle}
                        </h2>
                        <p className="text-steel text-lg max-w-2xl mx-auto">
                            {t.drywall.servicesSubtitle}
                        </p>
                    </div>

        ...
        <div className="min-h-screen bg-charcoal">
            ...
            <section className="pt-24 pb-16 bg-charcoal">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                        About <span className="text-copper">Master Contractor</span>
                    </h1>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {values.map((value, index) => (
                            <div key={index} className="bg-charcoal border border-slate-700 rounded-xl p-6 text-center">
                                <value.icon className="w-12 h-12 text-copper mx-auto mb-4" />
                    ...
                    <div className="space-y-6">
                        {milestones.map((milestone, index) => (
                            <div key={index} className="flex gap-6 items-start">
                                <div className="text-copper font-bold text-xl w-16 flex-shrink-0">
                                    {milestone.year}
                                </div>
                                <div className="flex-1 bg-charcoal border border-slate-700 rounded-lg p-4">
            ...
            <section className="py-16 bg-copper">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <Button asChild size="lg" className="bg-charcoal hover:bg-charcoal text-white font-semibold">
